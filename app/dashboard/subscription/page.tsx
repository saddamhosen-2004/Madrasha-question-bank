    ...
    <div style={{ width: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ color: 'white', fontSize: '1.9rem', fontWeight: 800, margin: '0 0 6px' }}>সাবস্ক্রিপশন ব্যবস্থাপনা</h1>
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.88rem', margin: 0 }}>আপনার সাবস্ক্রিপশন স্ট্যাটাস এবং পেমেন্ট রসিদ সমূহ</p>
        </div>
      </div>
              ...
              <div className="form-group" style={{ marginBottom: '18px' }}>
                ...
                <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                  ...
                  <label style={{ 
                    ...
                    <img src="/rocket.jpg" alt="Nagad" style={{ height: '40px', width: 'auto', objectFit: 'contain', borderRadius: '8px' }} />
                  ...
                  <label style={{ 
                    ...
                    <img src="/nagad.png" alt="Rocket" style={{ height: '40px', width: 'auto', objectFit: 'contain', borderRadius: '8px' }} />
