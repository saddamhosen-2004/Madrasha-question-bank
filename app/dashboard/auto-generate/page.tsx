    ...
    <div className="pb-24">
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ color: 'white', fontSize: '1.9rem', fontWeight: 800, margin: '0 0 6px' }}>⚡ Auto Generate প্রশ্নপত্র</h1>
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.88rem', margin: 0 }}>অধ্যায় এবং প্রশ্নের সংখ্যা উল্লেখ করুন, সিস্টেম স্বয়ংক্রিয়ভাবে প্রশ্ন নির্বাচন করবে</p>
        </div>
      </div>
