    ...
    <div className="space-y-6">
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ color: 'white', fontSize: '1.9rem', fontWeight: 800, margin: '0 0 6px' }}>কিতাব ব্যবস্থাপনা</h1>
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.88rem', margin: 0 }}>জামাত অনুযায়ী কিতাবের তালিকা ও ব্যবস্থাপনা</p>
        </div>
        <button 
          className="btn" 
          style={{ 
