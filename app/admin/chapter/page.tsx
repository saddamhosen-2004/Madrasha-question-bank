    ...
    <div className="space-y-6">
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ color: 'white', fontSize: '1.9rem', fontWeight: 800, margin: '0 0 6px' }}>চ্যাপ্টার ব্যবস্থাপনা</h1>
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.88rem', margin: 0 }}>কিতাব অনুযায়ী চ্যাপ্টারের তালিকা ও ব্যবস্থাপনা</p>
        </div>
        <button 
          className="btn" 
          style={{ 
            position: 'relative', 
            zIndex: 1, 
            background: !selectedKitabId ? 'rgba(255,255,255,0.5)' : 'white', 
            ...
            padding: '12px 24px',
            borderRadius: '12px',
            cursor: !selectedKitabId ? 'not-allowed' : 'pointer'
          }} 
          onClick={() => openModal()}
          disabled={!selectedKitabId}
        >
          + নতুন চ্যাপ্টার যুক্ত করুন
        </button>
      </div>
